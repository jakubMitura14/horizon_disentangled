...
- [x] **CPU Cores:** Set to 288 cores per job/node (Full Grace-Hopper node).
- [x] **Storage:** Set to 300TB for Scratch/Archive and 2TB for HOME.
- [x] **Resource Request:** Updated to 75,000 Node Hours (approx. 300,000 GPU Hours) to match the "100,000 GPU Hours/Year" target.
- [x] **Data Privacy:** Explicitly stated usage of "only synthetic and/or anonymized data".
