...
\subsubsection*{Gender equality plan}
Does the organisation have a Gender Equality Plan (GEP) covering the elements listed below? \\
\textbf{Yes} [\textbf{X}] \quad \textbf{No} [ ]

\subsection*{3 – Budget for the proposal}
...
\subsubsection*{ETHICS SELF-ASSESSMENT}
\textbf{Ethical dimension of the objectives, methodology and likely impact:} \\
The project involves retrospective analysis of patient data. Strict pseudonymization protocols will be enforced. No new interventions on patients are planned. \\
\textbf{Compliance with ethical principles and relevant legislations:} \\
All activities will comply with GDPR and the Declaration of Helsinki. Ethical approval will be obtained from the local ethics committee before data collection begins.
...
\subsubsection*{SECURITY SELF-ASSESSMENT}
\textit{Not applicable as no security issues were identified.}

\subsection*{5 – Other questions}

\subsubsection*{Two-stage calls}
Are there substantial differences compared to the stage-1 proposal? \\
\textbf{Yes} [ ] \quad \textbf{No} [\textbf{X}]

\subsubsection*{Clinical trials}
...
\end{tabular}
\\
\textit{Please upload the dedicated annex ‘Essential information for clinical studies / trials / investigations’.}
...
\begin{center}
\Large\textbf{TITLE OF THE PROPOSAL} \\
\large A Causal AI Framework for Longitudinal Modelling of Prostate Cancer
\end{center}
