\documentclass[whitelistedextension,showhints]{nhrproposal}
...
\SubprojectReport{[Sub-project title]}
\SubprojectReportProgress
\SubprojectReportChallenges
\SubprojectReportProblems

\SubprojectReport{[Sub-project title]}

\ProgressImprovements

\ShortProjectExtensionDescription
\ShortSubprojectDescription{[Sub-project title]}
\ShortSubprojectDescription{[Sub-project title]}

\ComputeResourcesExtension
\CodeOverview
%for one code
...
%second argument: resource usage specification, i.e., subproject;run type;programs used;problem size;#runs;#steps per run; Wall time per step [hours];#CPU-cores/run
