...
Our methodology is founded on a novel, multi-stage causal AI framework designed to deconstruct the complex problem of prostate cancer progression into a series of manageable, interconnected tasks. This modular approach, which leverages our consortium's extensive experience in synthetic image generation (CT from PET) and predictive modeling, ensures training stability, enhances interpretability, and allows us to systematically embed clinical domain knowledge as strong inductive biases, guiding the model to learn the true underlying causal mechanisms of the disease. The entire framework is illustrated in Figure \ref{fig:ml_framework}.
