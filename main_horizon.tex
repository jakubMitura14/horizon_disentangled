...
\begin{longtable}{p{0.05\textwidth} p{0.25\textwidth} p{0.1\textwidth} p{0.1\textwidth} p{0.4\textwidth}}
    ...
    \bottomrule
    \endlastfoot
    1 & Training Instability and Data Scalability & High & High & Sequential, multi-stage training framework to decompose complexity. Modular design allows for isolated troubleshooting. \\
    \addlinespace
