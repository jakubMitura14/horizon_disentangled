...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{WP2: Foundational Supervisor Model Training (54 PMs):} Develop supervisor models for clinical ground truth.
    \item \textbf{WP3: Causal VAE Development (65 PMs):} Develop the hierarchical \gls{vae} for disentanglement.
    \item \textbf{WP4: Temporal Trajectory Modeling (65 PMs):} Develop the \gls{njde} framework for longitudinal modeling. This work package will extend until the end of the project (M36). Towards the end of this period, the programmers will focus mainly on creating comprehensive documentation and refining the user interfaces for the clinical validation phase.
    \item \textbf{WP5: Validation and Clinical Integration (30 PMs):} Evaluate the framework's performance and clinical utility. This work package will now begin earlier, at month 15, to allow for a longer, more iterative validation process in parallel with the ongoing development in other work packages.
    \item \textbf{WP6: Dissemination, Communication, and Exploitation (10 PMs):} This work package will be managed in three 12-month cycles. It is dedicated to ensuring the project's results reach the widest possible audience and are positioned for maximum impact. Activities include publishing in high-impact journals, presenting at international conferences, maintaining the project website and open-source repositories, and engaging with clinical and patient communities. A detailed exploitation plan will be developed and refined throughout the project.
    \item \textbf{WP7: Project Management (10 PMs):} This work package will also be managed in three 12-month cycles to ensure continuous and effective project oversight. It covers all administrative, financial, and legal aspects of the project. A key responsibility is the implementation of the project's risk management plan and ensuring compliance with the EU AI Act through continuous monitoring and documentation.
    \item \textbf{WP8: Portfolio Activities (10 PMs):} This work package, structured in three 12-month cycles, is dedicated to fostering collaboration and synergy across the EIC Pathfinder Challenge portfolio. The project will actively participate in joint workshops, share best practices, and contribute to the development of a common strategic plan for the portfolio, ensuring our work aligns with and amplifies the impact of the broader EIC community.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc|c}
        ...
        \midrule
        \textbf{Person-Months} & 0 & 54 & 65 & 65 & 30 & 10 & 18 & 10 & \textbf{252} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{D2.1: Validated supervisor models} (WP2, Code, PU, M15)
    \item \textbf{D3.1: Disentangled VAE models} (WP3, Code, PU, M24)
    \item \textbf{D4.1: Trained Neural Jump ODE model} (WP4, Code, PU, M36)
...
\begin{table}[H]
    ...
    \begin{tabular}{lp{5.5cm}lcp{5cm}}
        ...
        M7 & Cross-modality synthesis validated & WP3 & M27 & Report showing that the quality of synthesized images (e.g., MRI-to-CT) meets a predefined threshold on quantitative metrics (SSIM > 0.85, FID < 50) and is deemed clinically acceptable by radiologists. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\cmidrule(lr){1-3}
Diagnostic CT \& mpMRI & Partner radiological practices & 700 \\
\midrule
\textbf{Total Minimum Proprietary Cohort} & & \textbf{1940} \\
\midrule
...
\textbf{Total Estimated Other Direct Costs: \EUR{233,800}}
...
\textbf{Total Direct Costs (A): \EUR{3,443,526}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{860,882}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{4,304,408}
...
WP3: Causal VAE & 800000 & 200000 & 1000000 \\
WP4: Temporal Modeling & 800000 & 200000 & 1000000 \\
WP5: Validation & 200000 & 50000 & 250000 \\
WP6: Dissemination & 67726 & 16932 & 84658 \\
WP7: Project Management & 200000 & 50000 & 250000 \\
\midrule
\textbf{Total} & {\textbf{3443526}} & {\textbf{860882}} & {\textbf{4304408}} \\
\bottomrule
\end{tabular}
\end{table}
