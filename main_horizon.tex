...
The total requested budget for the CausalPCa project is \textbf{\EUR{3,998,114}} over a period of 36 months. This budget is the result of a meticulous and strategic planning process based on the detailed financial tables provided separately. We are confident that this well-justified budget is both realistic and sufficient to deliver on all the project's ambitious objectives. The costs are broken down by Work Package (WP) and cost category, with detailed justifications provided below.
...
\textbf{Total Estimated Personnel Costs (incl. students): \EUR{2,919,592}}
...
This category consolidates all non-personnel direct costs required for the project.
\textbf{Total Estimated Other Direct Costs: \EUR{278,900}}
...
\textbf{Total Direct Costs (A): \EUR{3,198,491}}
\textbf{Indirect Costs (B = 25\% of A): \EUR{799,623}}

\subsubsection*{C. Total Project Budget}
\textbf{Total Estimated Project Cost (A + B): \EUR{3,998,114}}
...
Work Package &  &  &  \\
\midrule
WP1 & 688,553 & 172,138 & 860,691 \\
WP2 & 463,405 & 115,851 & 579,257 \\
WP3 & 461,392 & 115,348 & 576,740 \\
WP4 & 495,047 & 123,762 & 618,808 \\
WP5 & 518,277 & 129,569 & 647,846 \\
WP6 & 144,034 & 36,008 & 180,042 \\
WP7 & 309,630 & 77,407 & 387,037 \\
WP8 & 118,155 & 29,539 & 147,693 \\
\midrule
\textbf{Total} & \textbf{3,198,491} & \textbf{799,623} & \textbf{3,998,114} \\
\bottomrule
\end{tabular}
\end{table}
