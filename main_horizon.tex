...
\textbf{Risk 5 (Technical): Insufficient Computational Power} \\
\textit{Likelihood: Medium, Impact: High} \\
\textbf{Risk:} The advanced AI models proposed, particularly the large-scale training of generative models, are computationally intensive. A lack of sufficient and timely access to high-performance computing (HPC) resources could create significant bottlenecks and delay project milestones. \\
\textbf{Mitigation:} Our computational strategy is designed for resilience through a multi-source approach. We have guaranteed access to three in-house NVIDIA H200 GPUs for core development. Our primary plan is to secure large-scale resources from EuroHPC, leveraging our prior success with the KISSKI supercomputer. As a contingency for peak demand, we will use cloud computing resources, but strictly limited to training on synthetic data to ensure patient privacy. \\
\textbf{Expected Effect:} This creates multiple, independent sources of computational power, providing the project with the flexibility and redundancy needed to mitigate the risk of HPC-related delays and ensure a consistent development pace. \\
\bottomrule
\end{longtable}
...
\begin{itemize}
    ...
    \item \textbf{WP8: Portfolio Activities (11 PMs):} This work package, structured in three 12-month cycles, is dedicated to fostering collaboration and synergy across the EIC Pathfinder Challenge portfolio.
\end{itemize}
