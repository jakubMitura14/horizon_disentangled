...
\begin{itemize}
    ...
    \item \textbf{WP4: Temporal Trajectory Modeling (65 PMs):} Develop the \gls{njde} framework for longitudinal modeling.
...
\begin{itemize}
    ...
    \item \textbf{D4.1: Trained Neural Jump ODE model} (WP4, Code, PU, M30)
...
\begin{longtable}{>{\RaggedRight}p{0.4\textwidth} >{\RaggedRight}p{0.4\textwidth} >{\RagДRight\arraybackslash}p{0.2\textwidth}}
