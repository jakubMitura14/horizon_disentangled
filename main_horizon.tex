...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc|c}
        ...
        \midrule
        \textbf{Person-Months} & 78 & 58 & 58 & 58 & 56 & 16 & 36 & 12 & \textbf{372} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Senior Researcher (2 FTEs, 72 PMs):} The two senior researchers are the project's scientific backbone. They will be responsible for coordinating the technical and medical personnel and leading the hands-on work on the most challenging technical tasks (WP2-WP4). They will also be responsible for handling tasks related to Medical Device Regulation (MDR).
    \item \textbf{Clinical Investigator/Consultant (3 FTEs, 72 PMs):} These three experts (each at 24 PMs) are essential for ensuring the scientific validity and clinical relevance of the framework, leading validation efforts and ensuring data quality (WP1, WP4, WP5).
    \item \textbf{Mathematician (1 FTE, 30 PMs):} The mathematician's role is foundational to the project's scientific credibility, co-designing the novel causal models (WP2, WP3). After the 30-month mark, the core theoretical groundwork will be completed.
    \item \textbf{Data Scientist (1 FTE, 36 PMs):} A full-time Data Scientist is essential for building and managing the complex data pipeline in WP1.
    \item \textbf{Programmer (1 FTE, 36 PMs):} The programmer is required for the entire duration to build and maintain the project's software backbone (WP2, WP3).
    \item \textbf{Technician (1 FTE, 36 PMs):} The technician will be responsible for accessing and curating data from histopathology and supporting temporal modeling (WP1, WP4).
    \item \textbf{Project Manager (0.5 FTE, 18 PMs):} A project manager's continuous oversight is essential for coordinating data sharing, managing grant reporting, and ensuring EU AI Act compliance (WP7).
    \item \textbf{Secretary (1 FTE, 36 PMs):} A secretary will provide essential administrative support throughout the project (WP5, WP6, WP7).
\end{itemize}
\paragraph{Note on Supportive Roles:} The core project work detailed in the Work Packages is covered by the 372 person-months of the staff listed above. In addition, 37 person-months are budgeted for a \textbf{Student/Research Assistant} who will provide a crucial supportive role for data collection and clinical validation logistics, but whose effort is not allocated to the core WP totals. The funds from this position will also be used to award two scholarships for Bachelor’s theses.
\end{itemize>
