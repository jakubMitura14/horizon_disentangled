...
\begin{itemize}
    \item \textbf{WP1: Data Curation and Harmonization (85 PMs):} This foundational work package is dedicated to the meticulous gathering, anonymizing, and harmonization of the multi-modal data that underpins the entire project.
    ...
    \end{itemize}
    \item \textbf{WP2: Foundational Supervisor Model Training (65 PMs):} Develop supervisor models for clinical ground truth. \textbf{Lead and Key Personnel:} Mathematician, Programmer, Senior Researcher.
    \item \textbf{WP3: Causal VAE Development (65 PMs):} Develop the hierarchical \gls{vae} for disentanglement. \textbf{Lead and Key Personnel:} Senior Researcher, Mathematician, Programmer.
    \item \textbf{WP4: Temporal Trajectory Modeling (65 PMs):} Develop the \gls{njde} framework for longitudinal modeling. \textbf{Lead and Key Personnel:} Senior Researcher, Clinical Investigator/Consultant, Technician.
    \item \textbf{WP5: Validation and Clinical Integration (64 PMs):} Evaluate the framework's performance and clinical utility, starting at month 15. \textbf{Lead and Key Personnel:} Principal Investigator, Clinical Investigator/Consultant, Secretary.
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc|c}
        ...
        \midrule
        \textbf{Person-Months} & 85 & 65 & 65 & 65 & 64 & 16 & 36 & 12 & \textbf{408} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Clinical Investigator/Consultant (3 FTEs, 108 PMs):} These experts are essential for ensuring the scientific validity and clinical relevance of the framework, leading validation efforts and ensuring data quality (WP1, WP4, WP5).
...
\end{itemize}
\paragraph{Note on Supportive Roles:} The core project work detailed in the Work Packages is covered by the 408 person-months of the staff listed above. In addition, 37 person-months are budgeted for a \textbf{Student/Research Assistant} who will provide a crucial supportive role for data collection and clinical validation logistics, but whose effort is not allocated to the core WP totals. The funds from this position will also be used to award two scholarships for Bachelor’s theses.
\end{itemize>
