...
The project will be executed over 36 months, organized into seven interconnected Work Packages (WPs). The relationships and timing are visualized in the Gantt chart (Figure \ref{fig:gantt}), which is presented alongside the list of project deliverables to provide a comprehensive overview of the project timeline and its key outputs. The following tables provide a detailed breakdown of the work plan.
...
\begin{table}[H]
    ...
    \begin{tabular}{lp{4.5cm}lrrr}
        \toprule
        \textbf{WP No.} & \textbf{Work Package Title} & \textbf{Lead} & \textbf{Start} & \textbf{End} & \textbf{Person-Months} \\
        \midrule
        WP1 & Data Curation and Harmonization & Applicant & M1 & M33 & 30 \\
        WP2 & Foundational Supervisor Model Training & Applicant & M1 & M15 & 50 \\
        WP3 & Causal VAE Development & Applicant & M10 & M24 & 60 \\
        WP4 & Temporal Trajectory Modeling & Applicant & M18 & M30 & 60 \\
        WP5 & Validation and Clinical Integration & Applicant & M25 & M36 & 30 \\
        WP6 & Dissemination, Communication, and Exploitation & Applicant & M1 & M36 & 10 \\
        WP7 & Project Management & Applicant & M1 & M36 & 10 \\
        \midrule
        \multicolumn{5}{l}{\textbf{Total}} & \textbf{250} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{Project Gantt Chart illustrating the timeline for Work Packages, Deliverables, and Milestones.}
    \label{fig:gantt}
\end{figure}
