...
\begin{itemize}
    ...
    \item \textbf{Outcome 2: Increased Efficiency and Reduced Administrative Burden for Clinical Staff.}
        \begin{itemize}
            ...
            \item \textbf{Benefit:} The system will auto-populate reports with prognostic predictions, treatment simulations, and key imaging findings. We will measure the time saved in the clinical workflow study (WP5), with an expected 15\% reduction in manual documentation time per patient case, freeing up clinician time for direct patient care. The counterfactual visualizations will also allow radiologists to more quickly understand the AI's reasoning, with a target of reducing the time to interpret complex cases by 15\%.
        \end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{lp{5.5cm}lccr}
        ...
        D6.2 & Dissemination \& exploitation report (Y1) & WP6 & R & PU & M12 \\
        D6.3 & Dissemination \& exploitation report (Y2) & WP6 & R & PU & M24 \\
        D6.4 & Final dissemination \& exploitation plan & WP6 & R & PU & M36 \\
        D7.1 & Project management handbook & WP7 & R & CO & M2 \\
        D7.2 & Annual progress report (Y1) & WP7 & R & CO & M12 \\
        D7.3 & Annual progress report (Y2) & WP7 & R & CO & M24 \\
        D8.1 & Contribution to Portfolio Strategic Plan & WP8 & R & SEN & M6 \\
        D8.2 & Report on portfolio activities (Y1) & WP8 & R & SEN & M12 \\
        D8.3 & Report on portfolio activities (Y2) & WP8 & R & SEN & M24 \\
        D8.4 & Final report on portfolio activities (Y3) & WP8 & R & SEN & M36 \\
        \bottomrule
...
\begin{table}[H]
    \centering
    \caption{Total Person-Months per Work Package (Table 3.1f).}
...
\begin{itemize}
    ...
    \item \textbf{High-Throughput Data Processing:} The system's architecture, including features like GPUDirect Storage, is optimized to handle the large-scale (~200 Terabytes) multimodal datasets of this project, ensuring the powerful GPUs are never left "starved" for data.
\end{itemize}
