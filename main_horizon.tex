...
\end{itemize}
Crucially, the project's leadership team possesses a rare and powerful combination of interdisciplinary expertise. The team includes two medical doctors (MDs) with medical PhDs. One leader combines a specialization in nuclear medicine with a Master's degree in IT, providing a direct bridge between clinical application and technical implementation. The second leader holds a dual specialization in both nuclear medicine and radiology, offering an invaluable holistic perspective on the entire imaging pipeline. This unique blend of expertise, combined with our experience in managing patients through the entire spectrum of advanced therapies, ensures that the project is deeply grounded in both the clinical and technical domains—a critical success factor for this ambitious endeavor. The collaboration with external partners, including the Abteilung für Nuklearmedizin at Universitätsmedizin Halle, Universitätsmedizin Charite, and the Radiological Practice Rad. Sudenburg, will provide access to diverse data and clinical perspectives, further strengthening the project's foundation.

This unique blend of expertise is complemented by the applicant's clinic, which has extensive, hands-on experience in managing patients through the entire spectrum of advanced mCRPC therapies. Our clinical practice routinely administers a wide array of treatments, including second-generation Androgen Receptor Pathway Inhibitors (ARPIs) like abiraterone and enzalutamide, taxane-based chemotherapies such as docetaxel and cabazitaxel, and cutting-edge radioligand therapies (RLT) including Lutetium-177 PSMA and bone-targeted agents like Radium-223. The complexity of these cases necessitates regular multidisciplinary tumor boards, where detailed treatment decisions and patient responses are meticulously documented. This rich, real-world documentation provides an unparalleled source of high-quality data, crucial for training a causal model that can accurately learn the effects of different therapeutic interventions.
...
\clearpage % Start tables on a new page for better layout

\subsection{Work Packages, Deliverables, and Milestones}
The project is structured into seven Work Packages (WPs), with their relationships and timing illustrated in the Gantt chart (Figure \ref{fig:gantt}). The following tables provide a detailed breakdown of the work plan, including descriptions of each WP, a list of key deliverables, verifiable milestones, and person-month allocation.

\begin{table}[H]
    \centering
    \caption{Work Package Descriptions.}
    \label{tab:wp_descriptions}
    \small % Use smaller font for the table
    \begin{tabular}{lp{5cm}lrr}
        \toprule
        \textbf{WP No.} & \textbf{Work Package Title} & \textbf{Lead} & \textbf{Start} & \textbf{End} \\
        \midrule
        WP1 & Data Curation and Harmonization & Applicant & M1 & M33 \\
        WP2 & Foundational Supervisor Model Training & Applicant & M1 & M15 \\
        WP3 & Causal VAE Development & Applicant & M10 & M24 \\
        WP4 & Temporal Trajectory Modeling & Applicant & M18 & M30 \\
        WP5 & Validation and Clinical Integration & Applicant & M25 & M36 \\
        WP6 & Dissemination, Communication, and Exploitation & Applicant & M1 & M36 \\
        WP7 & Project Management & Applicant & M1 & M36 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \small
    \begin{tabular}{lp{4.5cm}lcccr}
        \toprule
        \textbf{Del. No.} & \textbf{Deliverable Name} & \textbf{WP} & \textbf{Lead} & \textbf{Type} & \textbf{Dissem.} & \textbf{Due} \\
        \midrule
        D1.1 & Curated, harmonized dataset (initial) & WP1 & App. & Data & CO & M12 \\
        D2.1 & Validated supervisor models & WP2 & App. & Code & PU & M15 \\
        D3.1 & Disentangled VAE models & WP3 & App. & Code & PU & M24 \\
        D4.1 & Trained Neural Jump ODE model & WP4 & App. & Code & PU & M30 \\
        D5.1 & Final validation report & WP5 & App. & R & PU & M36 \\
        D6.1 & Project website and open-source repo & WP6 & App. & Web & PU & M3 \\
        D6.2 & Mid-term dissemination report & WP6 & App. & R & PU & M18 \\
        D6.3 & Final dissemination \& exploitation plan & WP6 & App. & R & PU & M36 \\
        D7.1 & Project management handbook & WP7 & App. & R & CO & M2 \\
        \bottomrule
        \multicolumn{7}{p{14cm}}{\footnotesize \textbf{Type:} R=Report, Data=Dataset, Code=Software, Web=Website. \textbf{Dissem:} PU=Public, CO=Confidential.}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lp{5.5cm}lcp{5cm}}
        ...
        M2 & Supervisor models achieve >0.85 AUC on internal test set & WP2 & M15 & Validation report for supervisor models. \\
        M3 & VAE models demonstrate successful disentanglement & WP3 & M24 & Report with quantitative disentanglement metrics and qualitative results. \\
        M4 & NJDE model successfully predicts patient trajectories & WP4 & M30 & Report on temporal model performance with masked loss evaluation. \\
        M5 & Final integrated model validated in clinical study & WP5 & M36 & Final validation report including clinical plausibility study results. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \centering
    \caption{Summary of Person-Months per Work Package.}
