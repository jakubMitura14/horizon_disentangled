...
\begin{itemize}
    ...
    \item \textbf{Software Licenses:} A provision of \EUR{36,000} is budgeted for specialized software licenses. This covers subscriptions for AI-powered development and research tools, such as Gemini Ultra for the AI research assistant (Jules), Scispace for literature analysis, and Writefull for academic writing, to enhance the team's productivity and efficiency.
\end{itemize}

\textbf{Total Estimated Other Direct Costs: \EUR{58,000}}
...
\textbf{Total Direct Costs (A): \EUR{3,267,726}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{816,932}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{4,084,658}
...
\midrule
\textbf{Total} & {\textbf{3267726}} & {\textbf{816932}} & {\textbf{4084658}} \\
\bottomrule
\end{tabular}
\end{table}
