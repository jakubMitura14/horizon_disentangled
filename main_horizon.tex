...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc|c}
        ...
        \midrule
        \textbf{Person-Months} & 84 & 72 & 72 & 72 & 72 & 16 & 24 & 12 & \textbf{424} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{PhD Student (2 FTEs, 48 PMs total):} \EUR{228,000}
...
\begin{itemize}
    ...
    \item \textbf{PhD Student (2 FTEs, 24 months each):} Two PhD positions will be filled by medical students for a 24-month period each. Their clinical expertise is essential for bridging the gap between raw medical data and the technical AI team during the critical phases of data curation and validation.
        \begin{itemize}
            \item \textbf{PhD Student 1 (Data Curation & Quality Control):} This student will focus on data acquisition, standardization (WP1), and quality control, including the clinical review of the VAE-based outlier detection system (Task 1.5). This role requires a high level of medical understanding to ensure the integrity of the data foundation.
            \item \textbf{PhD Student 2 (Clinical Validation Lead):} This student will lead the clinical validation studies in \textbf{WP5}. Their role involves working directly with clinicians to assess the plausibility of the model's outputs, including counterfactual images and prognostic reports, ensuring the final tool is not only accurate but also clinically useful.
        \end{itemize}
