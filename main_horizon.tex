...
\begin{itemize}
    ...
    \item \textbf{PhD Student (3 FTEs, 108 PMs):} The three PhD positions will be filled by medical students whose doctoral work is integral to the project's data integrity. Their clinical expertise is essential for bridging the gap between raw medical data and the technical AI team. Each student will have a distinct focus to ensure comprehensive data governance and validation throughout the project's lifecycle:
        ...
        \end{itemize}
    \item \textbf{Mathematician (1 FTE, 36 PMs):} The mathematician's involvement is crucial for the entire project lifecycle. They will provide essential theoretical support for the novel causal models, ensure the mathematical soundness of the framework (especially the NJDEs in WP4), and develop robust uncertainty quantification methods, which will need continuous refinement as the models evolve.
...
\textbf{Total Estimated Other Direct Costs: \EUR{133,800}}
...
\textbf{Total Direct Costs (A): \EUR{3,343,526}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{835,882}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{4,179,408}
...
\midrule
\textbf{Total} & {\textbf{3343526}} & {\textbf{835882}} & {\textbf{4179408}} \\
\bottomrule
\end{tabular}
\end{table}
