...
\begin{itemize}
    ...
    \item \textbf{Data Scientist (1 FTE, 36 PMs, Externally Funded):} \EUR{0}
\end{itemize}

\textbf{Total Estimated Personnel Costs: \EUR{1,724,633}}

\paragraph{Personnel Justification}
The personnel budget is structured to support the project's ambitious goals through a dedicated, interdisciplinary team. The allocation of effort for each role has been carefully aligned with the scientific and technical workload of the project's Work Packages (WPs). The justification for each role is as follows:
\begin{itemize}
    \item \textbf{Principal Investigator (1 FTE, 36 PMs):} The PI will provide the overall scientific vision and leadership, ensuring the project stays on track and meets its objectives. They will coordinate the complex, interdisciplinary work across all WPs and lead the high-level scientific dissemination and exploitation activities (WP6, WP7).
    \item \textbf{Senior Researcher (3 FTEs, 108 PMs):} Three senior researchers are critical for the project's execution. Their roles are multifaceted, involving the crucial tasks of data curation, cleaning, and annotation across all data modalities (WP1), implementing and training the AI models (WP2, WP3, WP4), and conducting the rigorous experimental validation (WP5).
    \item \textbf{PhD Student (3 FTEs, 108 PMs):} The three PhD positions are essential for driving the core research and innovation of this project, with each student focusing on a distinct but complementary area of the causal AI framework. This division of labor ensures deep expertise is developed for each critical component of the methodology.
        \begin{itemize}
            \item \textbf{PhD Researcher 1} will focus on \textbf{WP2}, which involves developing the foundational supervisor models. This work, particularly Tasks 2.1 and 2.2, requires deep domain expertise in medical image analysis and the development of novel ordinal and survival loss functions. This research demands a high level of independent problem-solving and innovation to ensure the clinical validity of the ground-truth signals, a task beyond the scope of a research assistant.
            \item \textbf{PhD Researcher 2} is needed for \textbf{WP3}, which is centered on the development of the Causal VAEs for principled disentanglement (Task 3.1). This involves complex generative modeling and the design of novel loss functions to enforce the separation of anatomical, disease, and confounder signals. This work directly supports the core technical objective of creating a robust and generalizable model and requires doctoral-level training in advanced deep learning.
            \item \textbf{PhD Researcher 3} will work across \textbf{WP4 and WP5}, focusing on the temporal modeling with Neural Jump ODEs (Task 4.1) and leading the subsequent clinical validation (Task 5.1). This requires a broad understanding of both dynamic systems modeling and clinical trial design. The researcher will be responsible for adapting cutting-edge research into a functional experimental prototype and then rigorously testing its real-world utility, a role that demands the integrative skills of a doctoral candidate.
        \end{itemize}
    \item \textbf{Mathematician (1 FTE, 36 PMs):} A mathematician is required to provide the essential theoretical support for the novel causal models being developed. This role will focus on ensuring the mathematical soundness of the framework, particularly the complex Neural Jump ODEs (WP4), and will contribute to the development of robust uncertainty quantification methods.
    \item \textbf{Data Scientist (1 FTE, 36 PMs):} A full-time Data Scientist is essential for managing the complex data pipeline in WP1. This role, fully funded by the SIKIT project, will be responsible for data curation, harmonization, and implementing the VAE-based outlier detection system. Their expertise ensures the project is built on a high-quality, reliable dataset without incurring additional personnel costs to this grant.
    \item \textbf{Programmer (2 FTEs, 72 PMs):} Two full-time programmers are required to build the robust, scalable, and production-ready software that forms the backbone of this project. They will be responsible for the end-to-end software engineering, including developing the data processing pipelines (WP1), implementing the AI models with a focus on efficiency and optimization (WP2, WP3, WP4), and creating the user-facing clinical validation tools (WP5).
    \item \textbf{Project Manager (1 FTE, 36 PMs):} A project manager is essential for the operational success of this multi-partner project. This role extends beyond standard administrative duties to include coordinating data sharing and harmonization between the collaborating clinics (WP1), managing the grant documentation and reporting to the EC, and actively tracking development logs to ensure all project activities are compatible with the principles and requirements of the EU AI Act (WP7).
    \item \textbf{Secretary (1 FTE, 36 PMs):} A secretary will provide essential administrative support for the project, including organizing meetings, managing correspondence, and maintaining project records, thereby ensuring the smooth operation of all work packages.
    \item \textbf{Student/Research Assistant (40hrs/month, 36 months):} A part-time research assistant will provide essential support for the data collection efforts (WP1) and the clinical validation studies in WP5, assisting with patient data management and study logistics.
\end{itemize>
...
\textbf{Total Direct Costs (A): \EUR{2,190,733}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{547,683}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{2,738,416}
...
\midrule
WP1: Data Curation & 0 & 0 & 0 \\
WP2: Supervisor Models & 470700 & 117675 & 588375 \\
WP3: Causal VAE & 590000 & 147500 & 737500 \\
WP4: Temporal Modeling & 590000 & 147500 & 737500 \\
WP5: Validation & 275000 & 68750 & 343750 \\
WP6: Dissemination & 90000 & 22500 & 112500 \\
WP7: Project Management & 175033 & 43758 & 218791 \\
\midrule
\textbf{Total} & {\textbf{2190733}} & {\textbf{547683}} & {\textbf{2738416}} \\
\bottomrule
\end{tabular}
\end{table}
