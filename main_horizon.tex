...
\subsection{Outcomes}
This project is designed to generate specific, measurable, and credible outcomes for clearly defined target groups. The pathways to achieving these outcomes are credible because they are directly linked to the project's concrete deliverables and a comprehensive validation strategy (WP5). The successful completion of the project, verified through our specific and measurable milestones, will directly contribute to the following outcomes:

\begin{itemize}
    \item \textbf{Outcome 1: Improved Clinical Decision-Making for Prostate Cancer Patients.}
        \begin{itemize}
            \item \textbf{Target Group:} Urologists, radiation oncologists, and medical oncologists in European hospitals.
            \item \textbf{Project Contribution:} The core deliverable is the "digital twin" (developed in WP2-4), a clinical decision support tool. This tool will provide patient-specific, 5-year prognostic forecasts for multiple treatment scenarios (e.g., active surveillance vs. immediate radiotherapy).
            \item \textbf{Benefit:} Clinicians can directly compare visualized outcomes, such as projected tumor volume on synthetic PET/CT scans and PSA level curves. This enables a more precise, evidence-based selection of treatment, with the goal of reducing over- and under-treatment by an estimated 15-20\% in the participating clinics, which will be measured in a dedicated study in WP5.
        \end{itemize}

    \item \textbf{Outcome 2: Increased Efficiency and Reduced Administrative Burden for Clinical Staff.}
        \begin{itemize}
            \item \textbf{Target Group:} Radiologists and clinical staff involved in tumor board meetings.
            \item \textbf{Project Contribution:} The clinical application tools developed in WP5 will feature automated generation of structured radiological reports.
            \item \textbf{Benefit:} The system will auto-populate reports with prognostic predictions, treatment simulations, and key imaging findings. We will measure the time saved in the clinical workflow study (WP5), with an expected reduction of 15\% of manual documentation per patient case, freeing up clinician time for direct patient care. The counterfactual visualizations will also allow radiologists to more quickly understand the AI's reasoning, with a target of reducing the time to interpret complex cases by 15\%.
        \end{itemize}

    \item \textbf{Outcome 3: Accelerated Clinical Research and Guideline Development.}
        \begin{itemize}
            \item \textbf{Target Group:} Clinical researchers, pharmaceutical companies, and guideline development committees (e.g., \gls{eau}).
            \item \textbf{Project Contribution:} The project will generate a high-quality, curated, multi-center dataset on prostate cancer, including one of Europe's most comprehensive datasets on $^{177}$Lu-\gls{psma} therapy. The trained model itself will serve as an \textit{in-silico} platform for generating and pre-testing clinical hypotheses.
            \item \textbf{Benefit:} Researchers can use our open-source framework to rapidly test hypotheses, such as identifying patient subgroups who benefit most from novel therapies. This can significantly reduce the time and cost of designing future clinical trials. For guideline committees, the project will provide crucial data to help resolve clinical uncertainties, such as the optimal use of \gls{psma} \gls{pet}/\gls{ct} in treatment planning.
        \end{itemize}
\end{itemize}

\subsection{Long-Term Impact}
Beyond the immediate outcomes for clinicians and researchers, this project is poised to generate significant long-term impacts that will ripple across European healthcare, science, and society.
\begin{itemize}
    \item \textbf{Scientific Impact:} By successfully developing and validating a causal "digital twin" for prostate cancer, this project will establish a new scientific paradigm for oncology research. This foundational framework will not only transform our understanding of prostate cancer but will also serve as a blueprint for developing similar causal models for other complex diseases. We expect this work to catalyze a new wave of research into causal AI in medicine, leading to more robust, explainable, and trustworthy clinical AI systems across the board.
    \item \textbf{Economic Impact:} The widespread adoption of this technology could lead to substantial economic benefits. By reducing over- and under-treatment, the framework can decrease the costs associated with ineffective therapies and the management of treatment-related side effects. Furthermore, by accelerating clinical research and enabling cheaper, faster \textit{in-silico} trials, the project can lower the cost of pharmaceutical R\&D. In the long term, the establishment of a new European standard for medical GenAI could foster a vibrant ecosystem of startups and SMEs, creating high-value jobs and solidifying Europe's position as a global leader in medical innovation.
    \item \textbf{Societal Impact:} The most profound impact will be on patients and their families. By enabling more precise, personalized, and effective cancer care, this project has the potential to significantly improve patient survival rates and quality of life. The framework's ability to provide clearer, more intuitive explanations of disease progression and treatment options will also empower patients, allowing them to take a more active role in their own care. Ultimately, by making cancer care more effective and efficient, this project will contribute to the long-term sustainability and resilience of European healthcare systems.
\end{itemize}
