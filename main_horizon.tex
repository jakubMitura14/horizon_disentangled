...
\begin{itemize}
    ...
    \item \textbf{Software Licenses:} A provision of \EUR{36,000} is budgeted for specialized software licenses. This includes the NVIDIA AI Enterprise suite, which is essential for the DGX system. It also covers subscriptions for AI-powered development and research tools, such as Gemini Ultra for the AI research assistant (Jules), Scispace for literature analysis, and Writefull for academic writing, to enhance the team's productivity and efficiency.
\end{itemize}
