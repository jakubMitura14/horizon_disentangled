...
\begin{itemize}
    ...
    \item \textbf{PhD Student (3 FTEs, 108 PMs):} The three PhD positions are essential for driving the core research and innovation over the full project timeline, with each student's work building progressively. This division of labor ensures deep expertise is developed for each critical component.
        \begin{itemize}
            \item \textbf{PhD Researcher 1} will focus on \textbf{WP2}. This work requires deep domain expertise in medical image analysis and the development of novel ordinal and survival loss functions. This research is a cornerstone for the entire project and demands a high level of independent problem-solving and innovation throughout all 36 months to refine the clinical validity of the ground-truth signals.
            \item \textbf{PhD Researcher 2} is needed for \textbf{WP3}, centered on the development of the Causal VAEs for principled disentanglement. This involves complex generative modeling and continuous refinement of the loss functions. This work is foundational and will require the full project duration to achieve the required robustness for the final model, demanding doctoral-level training in advanced deep learning.
            \item \textbf{PhD Researcher 3} will work across \textbf{WP4 and WP5}. Their focus on temporal modeling with Neural Jump ODEs (Task 4.1) will transition into leading the clinical validation (Task 5.1). This long-term role requires a broad understanding of both dynamic systems modeling and clinical trial design, as they will be responsible for adapting the research into a functional prototype and then rigorously testing its real-world utility over the project's second half.
        \end{itemize}
...
\textbf{Total Direct Costs (A): \EUR{2,399,874}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{599,969}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{2,999,843}
...
\midrule
WP1: Data Curation & 263141 & 65785 & 328926 \\
WP2: Supervisor Models & 510000 & 127500 & 637500 \\
WP3: Causal VAE & 640000 & 160000 & 800000 \\
WP4: Temporal Modeling & 640000 & 160000 & 800000 \\
WP5: Validation & 200000 & 50000 & 250000 \\
WP6: Dissemination & 50000 & 12500 & 62500 \\
WP7: Project Management & 96733 & 24184 & 120917 \\
\midrule
\textbf{Total} & {\textbf{2399874}} & {\textbf{599969}} & {\textbf{2999843}} \\
\bottomrule
\end{tabular}
\end{table}
