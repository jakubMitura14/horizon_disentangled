...
\begin{itemize}
    ...
    \textbf{Lead and Key Personnel:} Data Scientist, Clinical Investigator/Consultant.
    The tasks include:
    \begin{itemize}
    ...
    \item \textbf{WP5: Validation and Clinical Integration (72 PMs):} Evaluate the framework's performance and clinical utility, starting at month 15. \textbf{Lead and Key Personnel:} PI, Senior Researcher, Clinical Investigator/Consultant.
...
\begin{itemize}
    ...
    \item \textbf{Student/Research Assistant (40hrs/month, 36 months):} A part-time research assistant is needed for the entire project to provide continuous support for data collection efforts (WP1) and the clinical validation studies (WP5), assisting with ongoing patient data management and study logistics. The funds from this position will also be used to award two scholarships for Bachelor’s theses.
\end{itemize>
