...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{WP2: Foundational Supervisor Model Training (72 PMs):} Develop supervisor models for clinical ground truth. \textbf{Lead and Key Personnel:} Mathematician, Programmer, Senior Researcher.
    \item \textbf{WP3: Causal VAE Development (72 PMs):} Develop the hierarchical \gls{vae} for disentanglement. \textbf{Lead and Key Personnel:} Mathematician, Programmer, Senior Researcher, Principal Investigator.
    \item \textbf{WP4: Temporal Trajectory Modeling (72 PMs):} Develop the \gls{njde} framework for longitudinal modeling. \textbf{Lead and Key Personnel:} Clinical Investigator/Consultant, Technician, Student/Research Assistant.
    \item \textbf{WP5: Validation and Clinical Integration (72 PMs):} Evaluate the framework's performance and clinical utility, starting at month 15. \textbf{Lead and Key Personnel:} Principal Investigator, Clinical Investigator/Consultant, Secretary, Student/Research Assistant.
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc|c}
        ...
        \midrule
        \textbf{Person-Months} & 93 & 72 & 72 & 72 & 72 & 16 & 36 & 12 & \textbf{445} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\textbf{Total Estimated Personnel Costs: \EUR{2,919,591.44}}
...
\begin{itemize}
    ...
    \item \textbf{Senior Researcher (2 FTEs, 72 PMs):} The two senior researchers are the project's scientific backbone and are critical for the entire 36-month duration. They will be responsible for coordinating the technical and medical personnel, ensuring a seamless workflow between the different expert groups. Their role will involve hands-on work on the most challenging technical tasks, from model development (WP2-WP4) to leading the rigorous experimental validation (WP5) and preparing high-impact publications (WP6).
    \item \textbf{Clinical Investigator/Consultant (3 FTEs, 108 PMs):} These three experts from other clinics are essential for ensuring the scientific validity and clinical relevance of the framework. They will be responsible for the validation of the models, ensuring the quality of the data, and providing the necessary clinical expertise to guide the project.
    \item \textbf{Mathematician (1 FTE, 30 PMs):} The mathematician's role is foundational to the project's scientific credibility. They are responsible for ensuring the theoretical integrity of the entire framework. Their work will be critical in the initial phases for co-designing the novel causal models and loss functions (WP2, WP3) to ensure they are mathematically sound. Their expertise will be paramount in the development and validation of the Neural Jump ODEs (WP4). After the 30-month mark, the core theoretical groundwork will be completed, and their continuous involvement is no longer required.
    ...
    \item \textbf{Student/Research Assistant (37 PMs):} A part-time research assistant is needed for the entire project to provide continuous support for data collection efforts (WP1) and the clinical validation studies (WP5), assisting with ongoing patient data management and study logistics. The funds from this position will also be used to award two scholarships for Bachelor’s theses.
\end{itemize>

\subsubsection*{Computing Costs }
The project's computational strategy is built on a multi-layered, hybrid model designed to maximize both data security and computational power, ensuring resilience and adaptability. This approach combines secure in-house resources with access to Europe's top-tier supercomputing infrastructure.
...
\subsubsection*{A.2 Other Direct Costs}
This category includes costs for publications, dataset access, and other minor expenses.
\begin{itemize}
    \item \textbf{Travel Costs:} \EUR{32,500} is allocated for project meetings and dissemination at international conferences.
    \item \textbf{Open Access Publication Fees:} \EUR{15,000} is budgeted for Article Processing Charges (APCs).
    ...
    \item \textbf{Long-Term Data Storage (DIZ):} A cost of \EUR{75,800} is allocated for 200 Terabytes of secure data storage.
    \item \textbf{Other Work-Related Expenses:} A provision of \EUR{100,000} is budgeted for essential work-related expenses.
    \item \textbf{External Expert Consultations:} A provision of \EUR{15,000} is budgeted for external expert consultations.
    \item \textbf{Pre-CE Clinical Investigation Costs:} \EUR{81,600} is allocated for regulatory fees, ethics review, insurance, and operational study costs.
\end{itemize}
...
\textbf{Total Direct Costs (A): \EUR{3,198,491.44}}

\textbf{Indirect Costs (B = 25\% of A): \EUR{799,622.86}}

\subsubsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B):} \EUR{3,998,114.30}
...
\midrule
\textbf{Total} & {\textbf{3198491.44}} & {\textbf{799622.86}} & {\textbf{3998114.30}} \\
\bottomrule
\end{tabular}
\end{table}
