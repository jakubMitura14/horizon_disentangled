...
The total requested budget for the CausalPCa project is \textbf{\EUR{3,223,594}} over a period of 36 months. This budget is designed to provide the necessary resources to achieve the ambitious objectives outlined in this proposal. The costs are broken down by Work Package (WP) and cost category, with detailed justifications provided below. All costs are estimated in EUR.
...
\textbf{Total Direct Costs (A): \EUR{2,578,875}} \\
\textbf{Indirect Costs (B = 25\% of A): \EUR{644,719}}

\subsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B): \EUR{3,223,594}}
