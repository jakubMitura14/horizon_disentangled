...
The total requested budget for the CausalPCa project is \textbf{\EUR{2,838,750}} over a period of 36 months. This budget is designed to provide the necessary resources to achieve the ambitious objectives outlined in this proposal. The costs are broken down by Work Package (WP) and cost category, with detailed justifications provided below. All costs are estimated in EUR.
...
\textbf{Total Estimated Personnel Costs: \EUR{1,740,000}}
...
\begin{itemize}
    ...
    \item \textbf{UK Biobank Access:} A fee of \EUR{12,000} (based on an estimated £9,000 plus £1,000 for administration) is budgeted for access to the UK Biobank dataset, a key resource for validating our models on a large population cohort.
    \item \textbf{Consumables:} Minor costs for software licenses.
\end{itemize}

\textbf{Total Estimated Other Direct Costs: \EUR{46,000}}
...
\textbf{Total Direct Costs (A): \EUR{2,271,000}} \\
\textbf{Indirect Costs (B = 25\% of A): \EUR{567,750}}

\subsection*{C. Total Project Budget}
The total requested funding is the sum of total direct and indirect costs.

\textbf{Total Estimated Project Cost (A + B): \EUR{2,838,750}}
